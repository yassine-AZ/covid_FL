...
def create_data(data_base):
    ...
    splitfolders.ratio(data_base, output='Img/', seed=1234, ratio=(0.7, 0.1, 0.2), group_prefix=None)
...
train_data, valid_data, test_data = create_data('E:/Users/ADMIN1/cycle Dingenieur/s4/stage/projet/data_augm_clt2')
import flwr as fl
